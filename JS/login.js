...
function passvalid()
{
    ...
    var Givepassword=inputTags[1].value 
    var borders=document.getElementsByClassName("inputdiv")
    if(emailIDorPhno!=userGivenMailorNum &&pass!=Givepassword)
    {
        ...
        document.getElementById("status").innerHTML="User id and Password is Wrong";
    }
  else if(emailIDorPhno==userGivenMailorNum &&pass!=Givepassword)
    {
...
function passHid()
{
    ...
    document.getElementById("passvis").src="../Asset/images/closeEye.png";
}
function bigButton()
{
